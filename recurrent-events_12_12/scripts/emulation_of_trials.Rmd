...
Approximation of the truth under each regime of interest.
...
```{r counterfactual-results}

truth <- readRDS(here("data/truth_trials.RDS"))

truth_df <- tibble(Regime = c("A1=1,A2=0,A3=0",
                  "A1=0,A2=1,A3=0",
                  "A1=0,A2=0,A3=1",
                  "A1=1,A2=0,A3=0",
                  "A1=0,A2=1,A3=0",
                  "A1=0,A2=0,A3=1"),
       `Regime After Interval 3` = c(
         rep("Natural", 3),
         rep("Never Treat", 3)
       ),
       `Mean` = c(truth$treat_2_natural,
...
```{r print-counterfactuals,include=FALSE}
...
##################################################
# for all time points - not trial set-up
##################################################
...
results <- map_df(1:300, ~{
  
    dat <- map_df(1:400, ~run_trial(weeks=16,
                                           n_packs=2,
                                           interval_length=2,
                                    intervention=NULL) %>%
